...
public class RootMotionControlScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        leftFoot = this.transform.Find("basic_rig/basic_rig Pelvis/basic_rig L Thigh/basic_rig L Calf/basic_rig L Foot");
        rightFoot = this.transform.Find("basic_rig/basic_rig Pelvis/basic_rig R Thigh/basic_rig R Calf/basic_rig R Foot");
